...
void Doubly_linked_list::print() {
	Nodo* tmp = first;
	while (tmp->get_next() != nullptr) {
		cout << "\nCedula: " << tmp->get_data().get_id();
		cout << "\nNombre: " << tmp->get_data().get_name();
		cout << "\nApellido: " << tmp->get_data().get_last_name();
		cout << "\nDirección: " << tmp->get_data().get_direction();
		cout << "\nTelefono: " << tmp->get_data().get_phone();
		cout << "\nCorreo: " << tmp->get_data().get_email();
		cout << "\n Username:" << tmp->get_data().get_userame();
		cout << "\n Clave:" << tmp->get_data().get_clave();
		cout << "\n-----------------------------------------------------\n";
		tmp = tmp->get_next();
	}
}
